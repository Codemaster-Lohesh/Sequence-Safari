...
const pauseButton=document.querySelector('#pause div')
...
function updateSnakespeed(time){
  ...
  if (inputDirection.x!=0 || inputDirection.y!=0){
    if ((time/1000)-lasttime2 >=1){
      ...
      SNAKE_SPEED+=0.1;
      /* console.log([time,lasttime2,SNAKE_SPEED]); */ //Making sure the speed is updated properly
    }
  }
}
...
function main(currentTime) {
  ...
  if (checkFood()){
    ...
    highScoreEle.innerText=`High score: ${HackerHighscore}`;
  }
